...
--drop table dbo.#TempWithIdentity
    ...
    insert into dbo.#TempWithIdentity(ANDEL, POSTORT, POSTNUMMER, adress, NAMN, BETECKNING, ärndenr) select ANDEL, POSTORT, POSTNUMMER, adress, NAMN, BETECKNING, ärndenr from (select ANDEL, POSTORT, POSTNUMMER, adress, NAMN, BETECKNING, ärndenr from
     OrginalAndGeofir
    qvc union select ANDEL, POSTORT, POSTNUMMER, ADRESS, NAMN, BETECKNING, ärndenr from (select POSTORT, POSTNUMMER, ADRESS, NAMN, andel, ÄrendeNr4års2019.Fastighet as BETECKNING, ärndenr from
    tempExcel.dbo.årsPåm2019Compl
                                                                                                                                                                                                     join
    tempExcel.dbo.ÄrendeNr4års2019
    ...
    with
                ...
                CompletteratOrginal as (select max(i) as nrx, max(ANDEL) as ANDEL, POSTORT, POSTNUMMER, adress, NAMN, BETECKNING, ärndenr from dbo.#TempWithIdentity
